...
The study shows there is a significant difference in average score on the WORDSUM test between at least two levels of DEGREE. The p-value is 0.000236 which is less than 0.05, therefore, we reject the null hypothesis. The data above demonstrates WORDSUM average score results are high in those in higher levels of education. 
